...
const addValues = (arr) => {
  ...
  let newArr2 = arr.reduce( (acc,number) =>{
    acc = acc + number;
    return acc;
  }, 0)
  return newArr2
...
const addPurchases = (arr) => {
  let newArr3 = arr.reduce( (acc,number) =>{
    acc = acc + number.purchasePrice;
    return acc;
  }, 0)
  return newArr3
  // Solution code here...
...
const countNumberOfElements = (arr) => {
  let newArr4=arr.reduce((acc,number)=>{
    acc=arr.length;
    return acc;
  },0);
  return newArr4;
...
const returnNames = (arr) => {
  ...
  let newArr5= [];
  return arr.reduce((forArr,Arr) => {
    newArr5.push(forArr = Arr.name);
    return newArr5;
  },[]);
  // Solution code here...
};
