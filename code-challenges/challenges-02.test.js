...
const raisedToTheThird = (arr) => {
  ...
  let newArr1=[];
  arr.forEach(number=>{
    newArr1.push(Math.pow(number, 3))
  })
  return newArr1 ;
  // Solution code here...
};
...
const forLoopTwoToThe = (arr) => {
  ...
  return newArr4;
  // Solution code here...
  // Math.pow is a library function in side js from google
};
...
const forEachTwoToThe = (arr) => {
  let newArr5=[];
  arr.forEach(number=>{
    newArr5.push(Math.pow(2, number))
  })
  return newArr5
  // Solution code here...
